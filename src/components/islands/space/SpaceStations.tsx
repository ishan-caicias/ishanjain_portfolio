        ...
        {spaceStations.map((station, index) => (
          ...
          >
            <button
              ...
              className={`group ${station.visual} flex min-h-11 w-full items-center gap-2 rounded-full border bg-surface-elevated/85 px-3 py-2 text-left text-xs text-text-muted shadow-lg shadow-black/20 backdrop-blur-sm transition hover:border-gold-400 hover:text-text-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gold-400 sm:w-auto sm:min-w-32 sm:justify-center ${selectedStation === station.id ? "border-gold-400 ring-2 ring-gold-400/50" : "border-royal-500/50"}`}
            >
              <span
                aria-hidden="true"
