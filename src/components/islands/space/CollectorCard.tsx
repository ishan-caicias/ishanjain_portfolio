...
/**
 * The "collector card" dossier for a curated body or field star, in one of three visual
 * variants (holo/dossier/plate) the user can switch between. Ported from lines 900-1016
 * (template) + the `card`/`v*` computed groups in renderVals() (lines 1651-1710).
 */
  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={`relative z-10 max-h-[88vh] w-[min(380px,calc(100vw-40px))] animate-[ij-cardin_0.32s_ease-out_both] overflow-y-auto p-4 shadow-[0_40px_80px_rgba(0,0,0,0.6)] transition-transform duration-150 ease-out ${variantClass}`}
        style={{
          ...variantStyle,
        ...
        <div className="flex items-baseline justify-between gap-2.5 px-1 pb-2.5 pt-0.5">
          <div className="min-w-0">
            <div
              ...
              style={{ color: e.r === "field" ? rc : rc }}
            >
              {vHeadTag}
            </div>
            <div className="mt-0.5 font-heading text-[23px] font-bold leading-tight text-text-primary">
              {e.n}
            </div>
          ...
          <div className="mt-3 flex flex-col gap-1.5">
            {stats.map((st, i) => (
              <div key={i}>
                ...
                <div className="mt-0.5 h-[3px] overflow-hidden rounded-full bg-[#1a237e]/55">
                  <div
