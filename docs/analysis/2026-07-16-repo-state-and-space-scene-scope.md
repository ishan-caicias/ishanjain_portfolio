...
> **⚠ Audit correction (2026-07-17):** this document describes the **`main` branch**, not the
> working branch `feature/PF-07/background-spaceship-v2`. On the working branch the space scene
> shipped on 2026-07-08 (`SpaceScene.tsx`, `src/lib/space-engine.js`, TR-001…TR-009) and the
> stack is Astro 7 / TypeScript 6 since TR-010 (2026-07-13). The "integration step still needed"
> conclusion is therefore **void** for actual delivery work. Original text preserved below.
