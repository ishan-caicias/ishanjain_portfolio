...
- **Superseded texture note:** The original single-tier 1024 px policy was the Phase 1 baseline. Task 3.1 superseded it with the validated adaptive 1K/2K policy: `sci-fi-aircraft-spaceship-fighter-1k.glb` for data saver/low-capability or narrow/unknown devices and `sci-fi-aircraft-spaceship-fighter-2k.glb` for capable GPU tiers and wider screens. The ignored 4K source remains conversion material only. See [Phase 2.1 evidence](../test-reports/2026-07-16-space-scene-phase-2.1.md) and [adaptive quality design](../superpowers/specs/2026-07-16-dual-quality-ship-asset-design.md).
