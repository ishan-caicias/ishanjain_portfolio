...
| [0006](0006-babylon-default-cutover.md)             | 2026-07-19 | B6: cut the default engine to Babylon+WebGPU; legacy engine archived behind `?engine=webgl` for one release. Written ahead of the decision with its evidence gate attached    | **Proposed — gated** (owner device pass + ADR-0003 §B3)  |
